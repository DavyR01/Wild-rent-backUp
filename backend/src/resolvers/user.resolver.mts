...
import { validateEmail, validateExistingUser, validatePassword, validateUsername } from "../validators/authUser.validator-back.mjs";
...
export default class UserResolver {
   ...
   async register(
      ...
      try {
         ...
         validateUsername(newUserData.username)
